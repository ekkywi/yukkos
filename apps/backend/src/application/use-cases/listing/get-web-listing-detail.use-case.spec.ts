import { GetWebListingDetailUseCase } from './get-web-listing-detail.use-case';
...
describe('GetWebListingDetailUseCase', () => {
  it('returns images for the web detail response', async () => {
    ...
    const useCase = new GetWebListingDetailUseCase(repository as IListingRepository);
